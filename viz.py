...
def viz(sample, name='plot.png', show=True, alpha=0.2, ax=None, resample_d=(20,20,20)):
    ...
    for i in range(d):
        ...
        for ix in range(d):
            for jx in range(d):
                ...
                if ts != 0:
                    textm = axes[0].text(ix, jx, tm, ha="center", va="center", color="b", fontsize=8)
                    texts = axes[1].text(ix, jx, ts,ha="center", va="center", color="b", fontsize=8)
