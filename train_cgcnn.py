...
if __name__ == '__main__':
    ...
    training_data = CifDataGenerator(data_dir, batch_size=batch_size, start_idx=0, end_idx=namespace.ntrain)
    validation_data = CifDataGenerator(data_dir, batch_size=batch_size, start_idx=namespace.ntrain, end_idx=namespace.ntrain+namespace.nval)
